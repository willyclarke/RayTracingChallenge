...
TEST(Ch8Shadows, PuttingItTogether)
{
  ...
  ww::shared_ptr_object PtrMiddleHigh = ww::PtrDefaultSphere();
  ww::object &MiddleHigh = *PtrMiddleHigh;
  ...
  ww::shared_ptr_object PtrRightHigh = ww::PtrDefaultSphere();
  ww::object &RightHigh = *PtrRightHigh;
