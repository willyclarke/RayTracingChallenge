...
TEST(Ch13Cylinders, PuttingItTogether)
{
  ww::tup const ColorBrown = ww::Color(float(0x87) / float(0xff), float(0x63) / float(0xff), float(0x3b) / float(0xff));
  ww::tup const ColorBrownLight =
      ww::Color(float(0xba) / float(0xff), float(0x8f) / float(0xff), float(0x5d) / float(0xff));
  ...
  ptrPlane3->Transform =
      ww::TranslateScaleRotate(0.f, 0.f, 10.f, 1.f, 1.f, 1.f, ww::Radians(90.f), 0.f, ww::Radians(-45.f));
  ptrPlane3->Material.Ambient = 2.0f;
  ptrPlane3->Material.Color = ww::Color(.1f, .1f, .1f);
  ptrPlane3->Material.Diffuse = 0.5f;
  ptrPlane3->Material.Reflective = .7f;
  ptrPlane3->Material.Specular = 1.0f;
  ptrPlane3->Material.Shininess = 500.f;
  // ptrPlane3->Material.Pattern = ww::StripePattern(ColorBrown, ColorBrownLight);
  World.vPtrObjects.push_back(ptrPlane3);
  ...
  Cone->Maximum = 0.5f;
  Cone->Closed = true;
  Cone->Transform = ww::TranslateScaleRotate(0.f, 2.f, 0.f, 1.f, 1.f, 1.f, 0.f, 0.f, 0.f);
  Cone->Material.Shininess = 100.f;
  Cone->Material.Diffuse = 0.7f;
  Cone->Material.Ambient = 0.2f;
  Cone->Material.Color = Red;
  World.vPtrObjects.push_back(Cone);
  ...
  *pLight = ww::PointLight(ww::Point(-5.f, 25.f, -5.f), ww::Color(1.f, 1.f, 1.f));
  ...
  ww::tup const ViewFrom = ww::Point(0.f, 2.5f, -4.f);
  ww::tup const ViewTo = ww::Point(0.f, 3.f, 1.f);
  ww::tup const UpIsY = ww::Vector(0.f, 1.f, 0.f);
  Camera.Transform = ww::ViewTransform(ViewFrom, ViewTo, UpIsY);

  ww::canvas Canvas = ww::Render(Camera, World);
  ww::WriteToPPM(Canvas, "Ch13PuttingItTogether.ppm");
}

//------------------------------------------------------------------------------
// Scenario: Putting it together.
TEST(Ch13Cylinders, PuttingItTogetherTake2)
{
  ww::tup const ColorBrown = ww::Color(float(0x87) / float(0xff), float(0x63) / float(0xff), float(0x3b) / float(0xff));
  ww::tup const ColorBrownLight =
      ww::Color(float(0xba) / float(0xff), float(0x8f) / float(0xff), float(0x5d) / float(0xff));
  ...
  ptrPlane->Transform = ww::TranslateScaleRotate(0.f, 0.f, 0.f, 1.f, 1.f, 1.f, 0.f, 0.f, 0.f);
  ptrPlane->Material.Shininess = 10.f;
  ptrPlane->Material.Diffuse = 0.2f;
  ptrPlane->Material.Ambient = 2.f;
  // ptrPlane->Material.Reflective = 1.f;
  ptrPlane->Material.Pattern = ww::CheckersPattern(ww::Color(0.f, 0.f, 0.f), ww::Color(1.f, 1.f, 1.f));
  ptrPlane->Transform = ww::RotateY(ww::Radians(45.f));
  ptrPlane->Material.Color = ww::Color(float(0xff) / float(0xff), float(0xe9) / float(0xff), float(0xca) / float(0xff));
  ...
  Cone->Maximum = -0.25f;
  // Cone->Closed = true;
  Cone->Transform = ww::TranslateScaleRotate(-0.f, 2.5f, 0.5f,  //!<
                                             .5f, 1.f, .5f,     //!<
                                             0.f, 0.f, 0.f);
  Cone->Material.Shininess = 0.f;
  Cone->Material.Diffuse = 0.9f;
  Cone->Material.Ambient = 0.2f;
  Cone->Material.Specular = 0.1f;
  Cone->Material.Color = ww::Color(0.5f, 0.f, 0.f);
  Cone->Material.Pattern = P1Perturbed;
  World.vPtrObjects.push_back(Cone);

  ww::cone Cone2 = *Cone;
  Cone2.Minimum = -0.25f;
  Cone2.Maximum = 0.f;
  Cone2.Transform = ww::TranslateScaleRotate(Cone->Transform.R0.W, 2.5f, Cone->Transform.R2.W,  //!<
                                             Cone->Transform.R0.X, 1.f, Cone->Transform.R2.Z,   //!<
                                             0.f, 0.f, 0.f);
  Cone2.Material.Pattern = {};
  Cone2.Material.Color = {};
  ww::shared_ptr_cone ptrCone2 = ww::PtrDefaultCone();
  *ptrCone2 = Cone2;
  World.vPtrObjects.push_back(ptrCone2);

  ww::shared_ptr_cylinder Cyl = ww::PtrDefaultCylinder();
  Cyl->Minimum = 0.f;
  Cyl->Maximum = 2.f;
  Cyl->Transform = ww::TranslateScaleRotate(Cone->Transform.R0.W, 0.f, Cone->Transform.R2.W,              //!<
                                            Cone->Transform.R0.X / 2.f, 1.f, Cone->Transform.R2.Z / 2.f,  //!<
                                            0.f, 0.f, 0.f);
  World.vPtrObjects.push_back(Cyl);

  ww::shared_ptr_light pLight{};
  pLight.reset(new ww::light);
  *pLight = ww::PointLight(ww::Point(-5.f, 7.5f, -5.f), ww::Color(1.f, 1.f, 1.f));
  World.vPtrLights.push_back(pLight);
  ...
  ww::tup const ViewFrom = ww::Point(-0.f, 4.5f, -5.f);
  ww::tup const ViewTo = ww::Point(2.0f, 0.f, 5.f);
  ww::tup const UpIsY = ww::Vector(0.f, 1.f, 0.f);
  Camera.Transform = ww::ViewTransform(ViewFrom, ViewTo, UpIsY);

  ww::canvas Canvas = ww::Render(Camera, World);
  ww::WriteToPPM(Canvas, "Ch13PuttingItTogether2.ppm");
}
