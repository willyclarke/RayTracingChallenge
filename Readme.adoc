...
* C++ — this directory (build instructions below).
* Rust — link:RUST/rtc-rust/README.md[RUST/rtc-rust]: complete through chapter 17 plus the
  bonus chapters; its README also sketches a JSON scene format for a scene-file-driven renderer.
* Zig — ZIG/raytracer-zig: work in progress.
