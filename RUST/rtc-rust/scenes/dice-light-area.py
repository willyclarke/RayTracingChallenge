#!/usr/bin/env python3
"""Generate scenes/dice-light-area.json: three dice stacked/slanted in a
checkered room, lit by an area light (soft shadows).
...
Usage: python3 scenes/dice-light-area.py [width height]   (default 3456 2234)
"""
...
def scene(width, height):
    ...
    return {
        "comment": [
            ...
            "Generated by scenes/dice-light-area.py - edit that, not this.",
        ],
        "camera": {
...
def main():
    ...
    out = "scenes/dice-light-area.json"
