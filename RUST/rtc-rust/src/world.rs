...
mod tests {
    ...
    /// Chap 16 - Smooth shading: a torus with vertex normals. The mesh in
    ...
    #[test]
    fn test_chap_16_smooth_torus() -> std::io::Result<()> {
        let mut w = World::new();
        ...
        let _rc = image.write_ppm("test_chap_16_smooth_torus.ppm");
